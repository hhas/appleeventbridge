...
//  AEMTestClause.h
//
//  Use to construct AEMIts-based object specifiers (a.k.a. 'whose clauses')
//  for use in -[AEMMultipleElementsSpecifier byTest:] reference form
//  constructor.
//
...
void AEMInitTestClauseModule(void); // called automatically by AEMSpecifier.m


/**********************************************************************/
// Abstract base class for all comparison and logic test classes

@interface AEMTestClause : AEMQuery
...
@interface AEMComparisonTest : AEMTestClause {
...
@interface AEMLogicalTest : AEMTestClause {
	NSArray *operands;	
}
