...
@implementation TETActivateCommand
...
@implementation TETCloseCommand
...
@implementation TETCountCommand
...
@implementation TETDeleteCommand
- (NSString *)aebCommandName {
    return @"delete";
}
- (NSString *)aebParameterNameForCode:(DescType)code {
...
@implementation TETDuplicateCommand
...
@implementation TETExistsCommand
- (NSString *)aebCommandName {
    return @"exists";
}
- (NSString *)aebParameterNameForCode:(DescType)code {
...
@implementation TETLaunchCommand
- (NSString *)aebCommandName {
    return @"launch";
}
- (NSString *)aebParameterNameForCode:(DescType)code {
...
@implementation TETOpenLocationCommand
...
@implementation TETPrintCommand
...
@implementation TETReopenCommand
- (NSString *)aebCommandName {
    return @"reopen";
}
- (NSString *)aebParameterNameForCode:(DescType)code {
...
@implementation TETSpecifier
- (NSString *)description {
    return [TETFormatter formatObject: self.aemQuery appData: self.aebAppData];
}
// Properties
- (instancetype)bounds {
...
- (TETActivateCommand *)activate {
    return [TETActivateCommand commandWithAppData: self.aebAppData
...
- (TETCloseCommand *)close {
    return [TETCloseCommand commandWithAppData: self.aebAppData
...
- (TETCountCommand *)count {
    return [TETCountCommand commandWithAppData: self.aebAppData
                       eventClass: 0x636f7265
                          eventID: 0x636e7465
                  directParameter: (__bridge id)kAEBNoDirectParameter
                      parentQuery: self.aemQuery];
...
- (TETDeleteCommand *)delete {
    return [TETDeleteCommand commandWithAppData: self.aebAppData
                       eventClass: 0x636f7265
                          eventID: 0x64656c6f
                  directParameter: (__bridge id)kAEBNoDirectParameter
                      parentQuery: self.aemQuery];
...
- (TETDuplicateCommand *)duplicate {
    return [TETDuplicateCommand commandWithAppData: self.aebAppData
                       eventClass: 0x636f7265
                          eventID: 0x636c6f6e
                  directParameter: (__bridge id)kAEBNoDirectParameter
                      parentQuery: self.aemQuery];
...
- (TETExistsCommand *)exists {
    return [TETExistsCommand commandWithAppData: self.aebAppData
                       eventClass: 0x636f7265
                          eventID: 0x646f6578
                  directParameter: (__bridge id)kAEBNoDirectParameter
                      parentQuery: self.aemQuery];
...
- (TETGetCommand *)get {
    return [TETGetCommand commandWithAppData: self.aebAppData
                       eventClass: 0x636f7265
                          eventID: 0x67657464
                  directParameter: (__bridge id)kAEBNoDirectParameter
                      parentQuery: self.aemQuery];
...
- (TETLaunchCommand *)launch {
    return [TETLaunchCommand commandWithAppData: self.aebAppData
...
- (TETMakeCommand *)make {
    return [TETMakeCommand commandWithAppData: self.aebAppData
                       eventClass: 0x636f7265
                          eventID: 0x6372656c
                  directParameter: (__bridge id)kAEBNoDirectParameter
                      parentQuery: self.aemQuery];
...
- (TETMoveCommand *)move {
    return [TETMoveCommand commandWithAppData: self.aebAppData
                       eventClass: 0x636f7265
                          eventID: 0x6d6f7665
                  directParameter: (__bridge id)kAEBNoDirectParameter
                      parentQuery: self.aemQuery];
...
- (TETOpenCommand *)open {
    return [TETOpenCommand commandWithAppData: self.aebAppData
...
- (TETOpenLocationCommand *)openLocation {
    return [TETOpenLocationCommand commandWithAppData: self.aebAppData
...
- (TETPrintCommand *)print {
    return [TETPrintCommand commandWithAppData: self.aebAppData
                       eventClass: 0x61657674
                          eventID: 0x70646f63
                  directParameter: (__bridge id)kAEBNoDirectParameter
                      parentQuery: self.aemQuery];
...
- (TETQuitCommand *)quit {
    return [TETQuitCommand commandWithAppData: self.aebAppData
                       eventClass: 0x61657674
                          eventID: 0x71756974
                  directParameter: (__bridge id)kAEBNoDirectParameter
                      parentQuery: self.aemQuery];
...
- (TETReopenCommand *)reopen {
    return [TETReopenCommand commandWithAppData: self.aebAppData
                       eventClass: 0x61657674
                          eventID: 0x72617070
                  directParameter: (__bridge id)kAEBNoDirectParameter
                      parentQuery: self.aemQuery];
...
- (TETRunCommand *)run {
    return [TETRunCommand commandWithAppData: self.aebAppData
                       eventClass: 0x61657674
                          eventID: 0x6f617070
                  directParameter: (__bridge id)kAEBNoDirectParameter
                      parentQuery: self.aemQuery];
...
- (TETSaveCommand *)save {
    return [TETSaveCommand commandWithAppData: self.aebAppData
                       eventClass: 0x636f7265
                          eventID: 0x73617665
                  directParameter: (__bridge id)kAEBNoDirectParameter
                      parentQuery: self.aemQuery];
...
- (TETSetCommand *)set {
    return [TETSetCommand commandWithAppData: self.aebAppData
                       eventClass: 0x636f7265
                          eventID: 0x73657464
                  directParameter: (__bridge id)kAEBNoDirectParameter
                      parentQuery: self.aemQuery];
...
- (instancetype)initWithTargetType:(AEBTargetType)targetType_ data:(id)targetData_ {
    AEBStaticAppData *data = [[AEBStaticAppData alloc] initWithApplicationClass: AEMApplication.class
                                                                    symbolClass: TETSymbol.class
                                                                 specifierClass: TETSpecifier.class
...
- (TETSpecifier *)customRoot:(id)object {
    if ([object isKindOfClass: TETSpecifier.class]) {
        return [[TETSpecifier alloc] initWithAppData: self.aebAppData aemQuery: [object aemQuery]];
    } else if ([object isKindOfClass: AEMQuery.class]) {
        return [[TETSpecifier alloc] initWithAppData: self.aebAppData aemQuery: object];
    } else if (!object) {
        return [[TETSpecifier alloc] initWithAppData: self.aebAppData aemQuery: AEMApp];
    } else {
        return [[TETSpecifier alloc] initWithAppData: self.aebAppData aemQuery: AEMRoot(object)];
    }
}
@end
